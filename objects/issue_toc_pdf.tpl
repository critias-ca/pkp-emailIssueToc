 ...
 *}
{if !$heading}
	{assign var='heading' value='h2 style="font-weight: normal; font-family: Lato, sans-serif; letter-spacing: 0.6px;"'}
{/if}
{assign var='articleHeading' value='h3 style="font-weight: normal;"'}
{if $heading == "h3"}
...
{/if}
<div style="font-family: Lato, sans-serif;" class="obj_issue_toc">
		...
		{if $section.articles}
			...
			<ul class="cmp_article_list articles">
				{foreach from=$section.articles item=article}
					<li>
						{include file="frontend/objects/article_summary_pdf.tpl" heading=$articleHeading}
					</li>
				{/foreach}
			</ul>
		{/if}
